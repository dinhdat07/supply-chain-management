...
import { LayoutDashboard, Package, Users, BrainCircuit, ScrollText } from 'lucide-react';
          ...
          {navItems.map((item) => {
            ...
            return (
              <button
                ...
                `}
              >
                <Icon size={20} className={isActive ? 'text-pureWhite' : item.isHighlight ? 'text-rausch' : 'text-secondaryGray'} />
                {item.label}
              </button>
            );
          })}
